...
set(CMAKE_C_FLAGS "${COMMON_FLAGS} ${MCU_FLAGS} -Wno-pedantic")
set(CMAKE_CXX_FLAGS "${COMMON_FLAGS} ${MCU_FLAGS} -Wno-pedantic ${FRA_FLAGS} -fno-rtti -fno-exceptions -fno-threadsafe-statics")
